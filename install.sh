...
wget -q -c https://github.com/universaloj-test/oracle-jdk-tar-ball/raw/master/jdk-8u31-linux-x64.tar.gz
wget -q -c https://github.com/universaloj-test/oracle-jdk-tar-ball/archive/8u31.tar.gz
tar -czvf 8u31.tar.gz
cd oracle-jdk-tar-ball-8u31/
tar -xzvf jdk-8u31-linux-x64.tar.gz jdk1.8.0_31
...
cd ~ && wget -q -c https://raw.githubusercontent.com/universaloj-test/install-scripts/master/install/up && chmod +x /root/up
