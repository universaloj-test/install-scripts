...
cd ~
git clone https://github.com/universaloj-test/uoj-web.git --depth=1
git clone https://github.com/universaloj-test/uoj-judge.git --depth=1
...
cp ~/install-scripts/install/new_problem.sh \
	~/install-scripts/install/post-commit.sh \
	~/install-scripts/install/uoj-passwd \
	~/install-scripts/install/uoj-post-commit \
	~/install-scripts/install/gen-uoj-config.php \
	~/install-scripts/install/app_uoj233.sql \
